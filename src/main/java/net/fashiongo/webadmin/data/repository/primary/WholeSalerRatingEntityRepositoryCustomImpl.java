...
public class WholeSalerRatingEntityRepositoryCustomImpl implements WholeSalerRatingEntityRepositoryCustom {
	...
	@Override
	public Page<VendorRating> up_wa_GetVendorInfoRating(Integer retailerID, Integer WholeSalerID, int pageNum, int pageSize, Boolean active, String additional, LocalDateTime from, LocalDateTime to, String orderBy) {
		long offset = (pageNum - 1) * pageSize;
		long limit = pageSize;
		MSSQLServer2012Templates mssqlServer2012Templates = new MSSQLServer2012Templates();
		JPASQLQuery<VendorRating> jpasqlQuery = new JPASQLQuery<VendorRating>(entityManager,mssqlServer2012Templates);
