package net.fashiongo.webadmin.data.entity.primary.franchise;
...
public class FranchiseRetailerEntity {
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "RetailerID",referencedColumnName = "RetailerID",insertable = false,updatable = false)
	private MapFranchiseSubAccountEntity mapFranchiseSubAccount;
