...
public class HttpClientConfig {
	...
	@Value("${webAdminapi.paymentAPI_EndPoint}")
	private String paymentApiService;
	...
	public HttpClient paymentApiJsonClient() { return new HttpClient(paymentApiService, restTemplate()); }
